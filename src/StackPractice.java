...
//
        Stack<String> classmates = new Stack<>();
        classmates.add("Kellsey");
        classmates.add("Zack");
        classmates.add("Pocky");

        System.out.println(classmates);

        String lastMate = classmates.pop();
        System.out.println(lastMate);
        System.out.println(classmates);
        classmates.push(lastMate);
        System.out.println(classmates);
        classmates.push("Polly");
